module tb_hamming_logic_decoder;
    reg [20:0] A;
    reg rstn;
    reg clk;
    reg i_req;
    ...
    initial begin
        ...
        if (B==16'b1001110010010011) $display("Test Succeeded : Output %b is vaild.", B);
