...
var.add_argument("--epoch_start", type=int, default=34, help="학습 모델 파일 선택")
...
ds_loader = DataLoader(dataset=ds, batch_size=1, shuffle=False, num_workers=8)
...
optimizer = Adam(itertools.chain(em.parameters(), ed.parameters(),  cc.parameters(), cd.parameters(), gn.parameters()), lr=1e-5, eps=1e-8)
